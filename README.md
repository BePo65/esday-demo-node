...
This is a minimal demo for how to use the [esday](https://github.com/BePo65/esday) library in a node script. It simply emits the current date and a date in 5 days to the console.
